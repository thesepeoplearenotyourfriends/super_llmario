...
def construction_catalog() -> dict:
    ...
    return {"version":1,"topologyContract":{"neighborOrder":["top","right","bottom","left"],"note":"Catalog keys are explicit editor topology; MarioAI mask suffixes are provenance and are not decoded at runtime."},"families":{
      "terrain.overground":{"id":"terrain.overground","name":"Overground terrain","category":"terrain","type":"terrain","dimensions":{"cell":16},"manualAssets":["map.terrain.overground.grass_top.left","map.terrain.overground.grass_top.middle","map.terrain.overground.grass_top.right","map.terrain.overground.grass_top.alt_left","map.terrain.overground.grass_top.alt_middle","map.terrain.overground.grass_top.alt_right","map.terrain.overground.grass_edge.curved_left","map.terrain.overground.grass_edge.curved_middle","map.terrain.overground.grass_edge.curved_right","map.terrain.overground.rounded_corner.top_left","map.terrain.overground.rounded_corner.top_right","map.terrain.overground.rounded_corner.bottom_left","map.terrain.overground.rounded_corner.bottom_right","map.terrain.overground.dirt_fill.variant_0","map.terrain.overground.dirt_fill.variant_1","map.terrain.overground.dirt_fill.variant_2","map.terrain.overground.dirt_fill.variant_3","map.terrain.overground.dirt_fill.variant_4","map.terrain.overground.dirt_fill.variant_5"],"components":{"topology":{"0000":"map.terrain.overground.grass_top.middle","0100":"map.terrain.overground.grass_top.left","0001":"map.terrain.overground.grass_top.right","0101":"map.terrain.overground.grass_top.middle","0010":"map.terrain.overground.grass_top.middle","0110":"map.terrain.overground.grass_top.left","0011":"map.terrain.overground.grass_top.right","0111":"map.terrain.overground.grass_top.middle","1111":"map.terrain.overground.dirt_fill.variant_0"},"topologyFallback":{"strategy":"procedural","asset":"terrain.overground.procedural","style":{"fill":"#75451f","top":"#6abf31","topRatio":0.3125,"stroke":"rgba(0,0,0,.45)"}}},"ascii":{"import":"X","export":"X"},"topologyVerification":"Associations use only the visually named grass-top and dirt-fill pieces. Unclear corner and edge topologies retain the procedural fallback; historic MarioAI mask suffixes are not decoded."},
      ...
      ,"bush.span":{"id":"bush.span","name":"Bush","category":"decor","type":"span","dimensions":{"cell":16,"minW":2,"defaultW":3},"components":{"left":"map.bush.left","middle":"map.bush.middle","right":"map.bush.right"},"ascii":None}
      ,"mushroom.platform":{"id":"mushroom.platform","name":"Mushroom Platform","category":"terrain","type":"parametric","dimensions":{"cell":16,"minW":3,"defaultW":3,"minH":2,"defaultH":3},"components":{"cap":{"left":"map.mushroom_platform.cap.left","middle":"map.mushroom_platform.cap.middle","right":"map.mushroom_platform.cap.right"},"stem":{"left":"map.mushroom_platform.stem.left","middle":"map.mushroom_platform.stem.middle","right":"map.mushroom_platform.stem.right"}},"ascii":None}
    }}
